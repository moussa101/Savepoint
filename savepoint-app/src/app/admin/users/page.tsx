      ...
      >
        <div>
          <h1
            ...
            style={{ fontSize: 'var(--text-3xl)', marginBottom: 'var(--space-xs)' }}
          >
            Users Directory
          </h1>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 'var(--text-xs)', marginTop: 6 }}>
            Tip: Badges shows <strong>Official</strong> only when checked — not every row is
            official.
          </p>
        </div>
        ...
        <div style={{ overflowX: 'auto' }}>
          ...
          >
            <thead>
              ...
              >
                <th style={{ padding: 'var(--space-md) var(--space-lg)', color: 'var(--text-muted)', fontWeight: 500 }}>
                  User
                </th>
                <th style={{ padding: 'var(--space-md) var(--space-lg)', color: 'var(--text-muted)', fontWeight: 500 }}>
                  Email
              ...
              {users.map((user) => (
                ...
                >
                  ...
                  <td style={{ padding: 'var(--space-md) var(--space-lg)', color: 'var(--text-secondary)' }}>
                    {user.email}
                    {!user.emailVerified ? (
                      <div style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>Unverified</div>
                    ) : null}
                  </td>
                  <td style={{ padding: 'var(--space-md) var(--space-lg)' }}>
                    {user.isAdmin ? (
